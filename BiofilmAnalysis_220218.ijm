...
//The macro offers a segmentation of a biofilm given a multitiff or (z-stack) file of a single labelled fluorescent biofilm into microcolonies. For each, structural measurements are given in relation with their intensity.
